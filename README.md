...
**If you're interested specifically in checking the R notebook with the code and figures, you can find the latest version** [here](https://rawcdn.githack.com/mskilab-org/lung_coo_2025/57beddf71cfa293d7962e2a454fb21669292aad5/data/scLung_Figures.html) **.**
...
- The `COO_Simulations.R` file contains the code used for simulations for extended data figures 3D and 3E. The code as is will generate simulations for extended data figure 3E, but instructions are included in the code's comments to adjust for generating simulations for extended data figure 3E.
