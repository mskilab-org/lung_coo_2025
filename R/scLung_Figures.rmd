...
<script>
v// Get the button, and when the user clicks on it, execute myFunction
...
# tmb
extd_data_3 <- fread(file.path(params$fileLoc,'Fig3/3CDE_extd_data_3.csv'))
ik = 'tmb_75_pct'
...
pts_coo_id <- readRDS(file.path(params$fileLoc,'Fig4/4A_pts_coo_id.rds'))
...
pts_coo_id_4B <- readRDS(file.path(params$fileLoc,'Fig4/4B_pts_coo_id.rds'))
...
rel_risk = read.table(file.path(params$fileLoc,"Fig5/5B_luad_rel_risk.csv"),sep=",",header=T,row.names=1)
...
wcm = readRDS(file.path(params$fileLoc,"Fig5/5B_cov_res.rds"))
...
dt.plot = readRDS(file.path(params$fileLoc,"Fig5/5B_cov_res.rds"))
dt.plot$Cell_Type = dt.plot$celltype
dt.plot$tumor.type = "LUAD"
...
labels = read.table(file.path(params$fileLoc,"Fig5/5D_combined_emb_for_carc_for_homogenous_sikk_ep_500_nw.csv"),sep=",",header=TRUE)
...
seu.markers = readRDS(file.path(params$fileLoc,"Fig5/5E_seu_markers.rds")) 
...
normal_labs = fread(file.path(params$fileLoc,"EDF/EDF3/3_combined_emb_for_normal_for_homogenous_sikk_ep_nw5.csv"))
...
juan.genes.gr.nw = readRDS(file.path(params$fileLoc,"EDF/EDF4/4B_genes_gr_LUSC.rds"))
...
dt1 = readRDS(file.path(params$fileLoc,"EDF/EDF5/5ABC_DeconstructSigsV3_MutDensity_Patients_SikkCentroids_Vs_Genes_All_Celltypes_PreAvgExprP1.rds"))
dt2 = readRDS(file.path(params$fileLoc,"EDF/EDF5/5ABC_DeconstructSigsV3_MutDensity_Patients_SikkCentroids_Vs_Genes_All_Celltypes_PreAvgExprP2.rds"))
dt3 = readRDS(file.path(params$fileLoc,"EDF/EDF5/5ABC_DeconstructSigsV3_MutDensity_Patients_SikkCentroids_Vs_Genes_All_Celltypes_PreAvgExprP3.rds"))
...
luad_pairs = readRDS(file.path(params$fileLoc,"EDF/EDF5/5ABC_new.pairs.luad.rds"))
...
sikk.cent = readRDS(file.path(params$fileLoc,"EDF/EDF5/5ABC_epcells.rds"))
...
```{r, extfig5C, dropBelow = TRUE, results = "asis", echo = TRUE, out.width= "100%", fig.align = "center"}
#Load libraries
library(skitools)
...
sims_acc_results <- fread(file.path(params$fileLoc,'EDF/EDF6/6_luad_sims_results.csv'))
...
resDT = readRDS(file.path(params$fileLoc,"EDF/EDF7/7_testRun_withOverlap_Cov.rds"))
...
annotSikk = read.csv(file.path(params$fileLoc,"EDF/EDF7/7_sikk_meta_epi3.csv"))
...
nsclc_col <- readRDS(file.path(params$fileLoc,'EDF/EDF8/8A_nsclc_hm_col.rds'))
hm_lusc <- fread(file.path(params$fileLoc,'EDF/EDF8/8A_hm_lusc.csv'))
...
edf_8_data <- readRDS(file.path(params$fileLoc,'EDF/EDF8/8B_data.rds'))
...
pts_coo_id_edf9a <- readRDS(file.path(params$fileLoc,'EDF/EDF9/9A_pts_coo_id.rds'))
...
tmp.plot.luad.df3 <- readRDS(file.path(params$fileLoc,'EDF/EDF9/9B_data.rds'))
...
edf9 <- readRDS(file.path(params$fileLoc,'EDF/EDF9/9CDEF_data.rds'))
...
edf9g_a <- readRDS(file.path(params$fileLoc,'EDF/EDF9/9G_dataA.rds'))
edf9g_b <- readRDS(file.path(params$fileLoc,'EDF/EDF9/9G_dataB.rds'))
...
tmp.plot = readRDS(file.path(params$fileLoc,"EDF/EDF10/10AB_data.rds"))
