...
labels = read.table("../data/Fig5/5D_combined_emb_for_carc_for_homogenous_sikk_ep_500_nw.csv",sep=",",header=TRUE)
...
seu.markers = readRDS("../data/Fig5/5E_seu_markers.rds")
