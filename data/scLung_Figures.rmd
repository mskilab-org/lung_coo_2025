...
dt1 = readRDS(file.path(params$fileLoc,"DeconstructSigsV3_MutDensity_Patients_SikkCentroids_Vs_Genes_All_Celltypes_PreAvgExpr.rds"))
dt2 = readRDS(file.path(params$fileLoc,"DeconstructSigsV3_MutDensity_Patients_SikkCentroids_Vs_Genes_All_Celltypes_PreAvgExprP2.rds"))
dt3 = readRDS(file.path(params$fileLoc,"DeconstructSigsV3_MutDensity_Patients_SikkCentroids_Vs_Genes_All_Celltypes_PreAvgExprP3.rds"))
